...
export const ThirdPage = ({ isMobile, phone, setPhone, clearErrors, setError, register, errors }) => {
    return (
        <div className={c.cont}>
            ...
            <Card isMobile={isMobile} clearErrors={clearErrors} setError={setError} register={register} errors={errors} />
        </div>
    )
}