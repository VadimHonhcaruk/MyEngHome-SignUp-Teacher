...
export const SecondPage = ({ passwordCheck, setPasswordCheck, setCheckerOne, setCheckerTwo, password, setPassword, email, setEmail, register, errors, setError, clearErrors }) => {
    return (
        <div className={c.cont}>
            ...
            <CheckboxInputs setCheckerOne={setCheckerOne} setCheckerTwo={setCheckerTwo} register={register} />
        </div>
    )
}
