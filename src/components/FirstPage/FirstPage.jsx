...
export const FirstPage = ({ isMobile, day, setDay, month, setMonth, year, setYear, firstName, setFirstName, setSecondName, secondName, card, setCard, phone, setPhone, ageUnderEi, clearErrors, watch, setError, register, errors, now, isValideDate }) => {
    return (
