...
export const Card = ({ isMobile, setError, clearErrors, register, errors }) => {
    ...
    return (!isMobile ? <>
        ...
        {errorCard ? <p className={c.p}><Error />&nbsp;&nbsp;Неправильний номер карти</p> : <p className={c.crd}>Карта для переказу коштів за надані послуги</p>}
    </>
    )
}